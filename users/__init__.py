...
def register_user():
    if request.method == 'POST':
        ...
        result = requests.post(f'https://muhammadkhon.pythonanywhere.com/users/user?first_name={first_name}&last_name={last_name}&username={username}&phone_number={phone_number}')
